/* eslint-disable @typescript-eslint/camelcase, @typescript-eslint/triple-slash-reference, @typescript-eslint/no-unused-vars, @typescript-eslint/adjacent-overload-signatures */
...
declare module 'node-forge' {
    ...
    namespace pki {
        ...
        interface Certificate {
          ...
          /**
           * @description Gets an extension by its name or id.
           * @param {string|object} options - The name to use or an object.
    ...
    namespace pkcs7 {
      interface PkcsSignedData {
        ...
        addSigner(options: {
          key: string | Buffer | Uint8Array | pki.PrivateKey
      ...
      function messageFromPem(pem: string): any;
      function messageToPem(msg: any): string;
    }
    ...
    namespace tls {
      ...
      interface CertificateRequest {
        ...
        function createConnection(options: {
          server?: boolean
          sessionId?: Bytes | null
          caStore?: pki.CAStore | readonly pki.Certificate[]
